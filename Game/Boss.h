...
public:
	...
	static std::string bossWinsResponse; //The boss's response to the player's move if the boss wins
	static std::string bossLosesResponse; //The boss's response to the player if the boss loses
